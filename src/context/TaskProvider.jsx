...
export default function TaskProvider({ children }) {
    ...
    const values = { user, setUser, showSearch, setShowSearch, showFilter, setShowFilter, searchValue, setSearchValue, filter, setFilter, tasks, loading, setLoading, newTask, updateTask, toggleComplete, deleteTask, state, setState, showForm, setShowForm, showDashboard, setShowDashboard }
    return (
