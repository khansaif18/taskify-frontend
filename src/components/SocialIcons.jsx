...
export default function SocialIcons() {
    ...
    return (
        <div className="main">
            <div className="up">
                <a className="card1" target='_blank' href='https://www.instagram.com/khansaif_18/'>
                ...
                <a className="card2" target='_blank' href='https://twitter.com/khansaif_18'>
            ...
            <div className="down">
                <a className="card3" target='_blank' href='https://github.com/SA1FUU'>
                ...
                <a className="card4" onClick={() => {
                    toast('I am not on Discord! Hehe 😁')
                    setSocialShow(false)
                }}>
